...
def get_precooling_impact(
    ...
    *,
    ...
    data, err = _safe_get("/api/reports/precooling-impact", params=params, base_url=base_url, headers=headers)
    if err:
        return None, err
    return _validate_contract("/api/reports/precooling-impact", "GET /api/reports/precooling-impact", data)


def get_precooling_impact_filter_options(*, base_url: str | None = None, headers: dict | None = None) -> Tuple[Optional[Dict[str, Any]], Optional[str]]:
    data, err = _safe_get("/api/reports/precooling-impact/filter-options", params=None, base_url=base_url, headers=headers)
    if err:
        return None, err
...
def get_precooling_impact_history(
    ...
    *,
    ...
    if stream_id:
        params["stream_id"] = stream_id
    data, err = _safe_get("/api/reports/precooling-impact/history", params=params, base_url=base_url, headers=headers)
    if err:
        return None, err
...
def get_precooling_impact_session_detail(
    ...
    *,
    ...
    if stream_id:
        params["stream_id"] = stream_id
    data, err = _safe_get("/api/reports/precooling-impact/session-detail", params=params, timeout_s=timeout_s, base_url=base_url, headers=headers)
    if err:
        return None, err
...
def get_precooling_impact_session_timeseries(
    ...
    *,
    ...
    if stream_id:
        params["stream_id"] = stream_id
    data, err = _safe_get("/api/reports/precooling-impact/session-timeseries", params=params, timeout_s=timeout_s, base_url=base_url, headers=headers)
    if err:
        return None, err
...
def get_ops_watch_summary(
    *,
    ...
    for path in candidates:
        txt, err = _safe_get_text(path, params=params, base_url=base_url, headers=headers)
